...
namespace shopAcc.Application.System.Users
{
    public class UserService : IUserService
    {
        ...
        public async Task<ApiResult<string>> Authencate(LoginRequest request)
        {
            ...
            if (roles[0] != "admin")
            {
                return new ApiErrorResult<string>("Không có quyền truy cập");
            }
            var claims = new[]
            {
        ...
        public async Task<ApiResult<bool>> Register(RegisterRequest request)
        {
            ...
            var accBalance = new List<AccountBalance>();
        ...
        public async Task<ApiResult<bool>> ChangePassWord(Guid id, ChangePassWordRequest request)
        {
            ...
            return new ApiErrorResult<bool>("Mật khẩu phải có đủ kí tự hoa, kí tự thường và kí tự đặc biệt");
        }
    }
}